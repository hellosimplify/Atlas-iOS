...
@interface ATLConversationTableViewCell ()
    ...
    @property (nonatomic) CardViewObjC *cardView;
...
+ (void)initialize
    {
        ...
            proxy.conversationTitleLabelFont = [UIFont boldSystemFontOfSize:13];
            proxy.conversationTitleLabelColor = [UIColor colorWithRed:74.0f / 255.0f green:74.0f / 255.0f blue:74.0f / 255.0f alpha:1.0f];
            proxy.lastMessageLabelFont = [UIFont systemFontOfSize:12];
            proxy.lastMessageLabelColor = [UIColor colorWithRed:173.0f / 255.0f green:173.0f / 255.0f blue:173.0f / 255.0f alpha:1.0f];
            proxy.dateLabelFont = [UIFont systemFontOfSize:12];
            proxy.dateLabelColor = [UIColor colorWithRed:173.0f / 255.0f green:173.0f / 255.0f blue:173.0f / 255.0f alpha:1.0f];
...
- (void)lyr_commonInit
    {
        ...
            _cardView.backgroundColor = [UIColor colorWithRed:248.0f / 255.0f green:248.0f / 255.0f blue:248.0f / 255.0f alpha:1.0f];
        ...
            [self.cardView addSubview:_conversationImageView];
            
            
        ...
            [self.cardView addSubview:_groupChatView];
            
        ...
            [self.cardView addSubview:_conversationTitleLabel];
            
        ...
            [self.cardView addSubview:_lastMessageLabel];
            
        ...
            [self.cardView addSubview:_dateLabel];
            
        ...
            [self.cardView addSubview:_unreadMessageIndicator];
            
        ...
            _chevronIconView.image = [UIImage imageNamed:@"icoGreyTime" inBundle:resourcesBundle compatibleWithTraitCollection:nil];
            [self.cardView addSubview:_chevronIconView];
            
        ...
            [self configureCardViewLayoutContraints];
            
    }
...
- (void)layoutSubviews
    {
        ...
        self.conversationImageView.layer.cornerRadius = 8;
    }
...
- (void)configureConversationImageViewLayoutContraints
    {
            [self.cardView addConstraint:[NSLayoutConstraint constraintWithItem:self.conversationImageView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.cardView attribute:NSLayoutAttributeHeight multiplier:0.6 constant:0]];
            [self.cardView addConstraint:[NSLayoutConstraint constraintWithItem:self.conversationImageView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.conversationImageView attribute:NSLayoutAttributeWidth multiplier:1 constant:0]];
            [self.cardView addConstraint:[NSLayoutConstraint constraintWithItem:self.conversationImageView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.cardView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:10]];
            [self.cardView addConstraint:[NSLayoutConstraint constraintWithItem:self.conversationImageView attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.cardView attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0]];
    }
...
- (void)configureCardViewLayoutContraints
    {
            [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:self.cardView attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeLeading multiplier:1.0 constant: 5]];
